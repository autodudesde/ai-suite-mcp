...
class ListStaleContentTool extends AbstractTool
{
        ...
        if (null !== $rootPageId) {
            ...
            if (null !== $beUser && !$beUser->isAdmin()) {
                try {
                    ...
                    $this->logger->warning('ListStaleContentTool: webmount too large for global scan, asking user to scope by rootPageId', [
